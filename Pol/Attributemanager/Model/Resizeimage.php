<?php
	define("EWORKS_AUTO_NAME",1);
	class Pol_Attributemanager_Model_Resizeimage
	{
		var $imgFile="";
		var $imgWidth=0;
		var $imgHeight=0;
		...
		function Pol_Attributemanager_Model_Resizeimage($imgFile="")
		{
