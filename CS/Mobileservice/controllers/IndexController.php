<?php
class CS_Mobileservice_IndexController extends Mage_Core_Controller_Front_Action
{
	public function indexAction()
	{
		$cName = 'CS_Mobileservice_Main';
		//
	...
	//	print_r($headers);die;
		try {
			$con = mysql_connect("localhost","chattruser","8300DF35E40FB") or die("Unable to connect database.");
		...
		try{
		$server = new CS_Mobileservice_Server();
